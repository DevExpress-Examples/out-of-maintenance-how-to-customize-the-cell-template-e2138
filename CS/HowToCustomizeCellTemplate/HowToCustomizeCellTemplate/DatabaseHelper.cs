...
namespace HowToCustomizeCellTemplate
{
    public static class DatabaseHelper
    {
        ...
        {
            CustomerNames = GenerateUniqueValues(random.Next(20, 30), GeneratePersonName).ToArray();
            SalesPersonNames = GenerateUniqueValues(random.Next(20, 30), GeneratePersonName).ToArray();
        ...
        {
            return new DateTime(random.Next(2018, 2020), random.Next(1, 13), random.Next(1, 28));
        }
