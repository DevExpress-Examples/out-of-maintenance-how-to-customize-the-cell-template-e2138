...
Namespace HowToCustomizeCellTemplate
	Public NotInheritable Class DatabaseHelper
		...
		Shared Sub New()
			CustomerNames = GenerateUniqueValues(random.Next(20, 30), AddressOf GeneratePersonName).ToArray()
			SalesPersonNames = GenerateUniqueValues(random.Next(20, 30), AddressOf GeneratePersonName).ToArray()
		...
		Public Shared Function GetOrderDate() As Date
			Return New Date(random.Next(2018, 2020), random.Next(1, 13), random.Next(1, 28))
		End Function
